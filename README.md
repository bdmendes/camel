...
<pre>
  <b>$ </b>./scripts/gauntlet.sh [BRANCH/TAG]
</pre>
...
<pre>
  <b>$ </b>./scripts/deploy.sh
</pre>

## Usage

You can use a GUI such as [Scid](https://flathub.org/apps/details/io.github.benini.scid) to be able to play against the engine or analyze a game. Alternatively, you can explore the engine through the REPL, which builds on top of the UCI protocol.

<pre>
  <b>$ </b>position fen r1q1k1r1/pp1np1b1/5npp/1Q1NN1p1/3P4/4B2P/PPP2PP1/4RRK1 w q - 3 16
  <b>$ </b>display
  ♜ - ♛ - ♚ - ♜ - 
  ♟ ♟ - ♞ ♟ - ♝ - 
  - - - - - ♞ ♟ ♟ 
